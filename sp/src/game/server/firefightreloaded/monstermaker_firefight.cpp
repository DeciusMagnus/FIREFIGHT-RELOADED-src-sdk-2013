...
ConVar sk_spawner_min_fps("sk_spawner_min_fps", "25", FCVAR_ARCHIVE, "The minimum FPS to disable spawners due to lag.");
...
bool CNPCMakerFirefight::CanMakeNPC(bool bIgnoreSolidEntities)
{
	...
	if (dist > 0.0f)
	{
		bool isNotClose = (PlayerDistance(this, UTIL_GetNearestPlayer(GetAbsOrigin())) > dist);
