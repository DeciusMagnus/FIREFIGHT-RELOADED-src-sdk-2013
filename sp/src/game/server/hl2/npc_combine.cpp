...
DEFINE_FIELD( m_iNumGrenades, FIELD_INTEGER),
...
bool CNPC_Combine::CorpseGib(const CTakeDamageInfo& info)
{
		...
		&& info.GetDamageType() & (DMG_BLAST) && !(info.GetDamageType() & (DMG_DISSOLVE)) && gibs)
	{
		...
		CBaseEntity* pLeftArmGib = CreateRagGib(this, GetGibModel(APPENDAGE_ARML), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pLeftArmGib)
		{
		...
		CBaseEntity* pRightArmGib = CreateRagGib(this, GetGibModel(APPENDAGE_ARMR), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pRightArmGib)
		{
		...
		CBaseEntity* pTorsoGib = CreateRagGib(this, GetGibModel(APPENDAGE_TORSO), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pTorsoGib)
		{
		...
		CBaseEntity* pPelvisGib = CreateRagGib(this, GetGibModel(APPENDAGE_PELVIS), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pPelvisGib)
		{
		...
		CBaseEntity* pLeftLegGib = CreateRagGib(this, GetGibModel(APPENDAGE_LEGL), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pLeftLegGib)
		{
		...
		CBaseEntity* pRightLegGib = CreateRagGib(this, GetGibModel(APPENDAGE_LEGR), GetAbsOrigin(), GetAbsAngles(), GetRagForce(vecDamageDir), flFadeTime, IsOnFire());
		if (pRightLegGib)
		{
