...
ConVar	sk_plr_dmg_railgun("sk_plr_dmg_railgun", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_railgun("sk_npc_dmg_railgun", "0", FCVAR_REPLICATED);
...
ConVar	sk_plr_dmg_556round("sk_plr_dmg_556round", "0", FCVAR_REPLICATED);
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		else
		{
			for (i = 0; i<NUM_AI_CLASSES; i++)
			{
				for (j = 0; j<NUM_AI_CLASSES; j++)
				{
					...
					//everything should be neutral to advisor other than player and combine.
					else if (i == CLASS_NONE || i == CLASS_BULLSEYE || i == CLASS_FLARE || i == CLASS_COMBINE_ADVISOR)
					{
						CBaseCombatCharacter::SetDefaultRelationship((Class_T)i, (Class_T)j, D_NU, 0);
					}
					else if (j == CLASS_NONE || j == CLASS_BULLSEYE || j == CLASS_FLARE || i == CLASS_COMBINE_ADVISOR)
					{
						CBaseCombatCharacter::SetDefaultRelationship((Class_T)i, (Class_T)j, D_NU, 0);
					}
					else
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ALIEN_BIOWEAPON, CLASS_PLAYER_NPC, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_NPC, CLASS_ALIEN_BIOWEAPON, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY, CLASS_ALIEN_BIOWEAPON, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_BARNACLE, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_COMBINE_GUNSHIP, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_ALIEN_BIOWEAPON, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER, CLASS_COMBINE_ADVISOR, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER, CLASS_COMBINE_TURRET, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_COMBINE, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_COMBINE_GUNSHIP, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_COMBINE_HUNTER, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_MANHACK, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_SCANNER, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_ADVISOR, CLASS_COMBINE_TURRET, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_COMBINE_ADVISOR, D_HT, 0);
		...
		if (GlobalEntity_GetState("player_inbossbattle") == GLOBAL_ON)
		{
			...
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE, CLASS_PLAYER, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER, CLASS_ZOMBIE, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE, CLASS_PLAYER_ALLY, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY, CLASS_ZOMBIE, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE, CLASS_PLAYER_NPC, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_NPC, CLASS_ZOMBIE, D_LI, 0);

			CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE, CLASS_VORTIGAUNT, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_ZOMBIE, D_LI, 0);

			CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB, CLASS_PLAYER, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER, CLASS_HEADCRAB, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB, CLASS_PLAYER_NPC, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_NPC, CLASS_HEADCRAB, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB, CLASS_PLAYER_ALLY, D_LI, 0);
			CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY, CLASS_HEADCRAB, D_LI, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_NPC, CLASS_HUMAN_MILITARY, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_NPC, CLASS_VORTIGAUNT, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_PLAYER_NPC, D_LI, 0);
...
float CHalfLife2::GetAutoAimScale( CBasePlayer *pPlayer )
{
	...
	case SKILL_VERYHARD:
		return sk_autoaim_scale4.GetFloat();

	case SKILL_NIGHTMARE:
		return sk_autoaim_scale5.GetFloat();
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("AR2",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_ar2",			"sk_npc_dmg_ar2",			"sk_max_ar2",			BULLET_IMPULSE(200, 1225), 0, 'u' );
		def.AddAmmoType("AlyxGun",			DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_alyxgun",		"sk_npc_dmg_alyxgun",		"sk_max_alyxgun",		BULLET_IMPULSE(200, 1225), 0, 'p' );
		...
		def.AddAmmoType("RPG_Round",		DMG_BURN | DMG_BLAST,					TRACER_NONE,			"sk_plr_dmg_rpg_round",		"sk_npc_dmg_rpg_round",		"sk_max_rpg_round",		0, 0, 'x' );
		def.AddAmmoType("SMG1_Grenade",		DMG_BURN | DMG_ALWAYSGIB | DMG_BLAST, TRACER_NONE, "sk_plr_dmg_smg1_grenade", "sk_npc_dmg_smg1_grenade", "sk_max_smg1_grenade", 0, 0, 't');
		def.AddAmmoType("SniperRound",		DMG_BULLET | DMG_SNIPER,	TRACER_NONE,			"sk_plr_dmg_sniper_round",	"sk_npc_dmg_sniper_round",	"sk_max_sniper_round",	BULLET_IMPULSE(650, 6000), 0, 'r' );
		def.AddAmmoType("SniperPenetratedRound", DMG_BULLET | DMG_SNIPER, TRACER_NONE,			"sk_dmg_sniper_penetrate_plr", "sk_dmg_sniper_penetrate_npc", "sk_max_sniper_round", BULLET_IMPULSE(150, 6000), 0, 'r' );
//		def.AddAmmoType("Grenade",			DMG_BURN | DMG_ALWAYSGIB, TRACER_NONE, "sk_plr_dmg_grenade", "sk_npc_dmg_grenade", "sk_max_grenade", 0, 0, 'v');
		def.AddAmmoType("Thumper",			DMG_SONIC,					TRACER_NONE,			10, 10, 2, 0, 0 );
		def.AddAmmoType("Gravity",			DMG_CLUB,					TRACER_NONE,			0,	0, 8, 0, 0 );
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		def.AddAmmoType("Battery",			DMG_CLUB,					TRACER_NONE,			NULL, NULL, NULL, 0, 0 );
		def.AddAmmoType("GaussEnergy",		DMG_SHOCK | DMG_ALWAYSGIB, TRACER_NONE, "sk_plr_dmg_gauss", "sk_plr_dmg_gauss", "sk_max_gauss_round", BULLET_IMPULSE(650, 8000), 0, 'r'); // hit like a 10kg weight at 400 in/s
		def.AddAmmoType("CombineCannon",	DMG_BULLET,					TRACER_LINE,			"sk_npc_dmg_gunship_to_plr", "sk_npc_dmg_gunship", NULL, 1.5 * 750 * 12, 0 ); // hit like a 1.5kg weight at 750 ft/s
		def.AddAmmoType("AirboatGun",		DMG_AIRBOAT,				TRACER_LINE,			"sk_plr_dmg_airboat",		"sk_npc_dmg_airboat",		NULL,					BULLET_IMPULSE(10, 600), 0 );
		def.AddAmmoType("Railgun",			DMG_SHOCK | DMG_SNIPER,		TRACER_NONE, "sk_plr_dmg_railgun", "sk_npc_dmg_railgun", "sk_max_railgun", 0, 0, 'r');
