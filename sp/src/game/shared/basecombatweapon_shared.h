...
#define SF_WEAPON_NO_INITIALWEAPONSWITCH (1<<3)
...
public:
	...
	virtual bool			ShouldDisplayDualWieldHUDHint();
	virtual void			DisplayDualWieldHudHint();
	virtual void			RescindDualWieldHudHint(); ///< undisplay the hud hint and pretend it never showed.
...
public:
	...
	int						m_iDualWieldHudHintCount;		// How many times has this weapon displayed its store HUD hint?
	...
	bool					m_bDualWieldHudHintDisplayed;	// Have we displayed a store HUD hint since this weapon was deployed?
