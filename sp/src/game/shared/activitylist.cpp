...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_RUN);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_CROUCH_WALK);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_CROUCH_IDLE);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_GESTURE_RANGE_ATTACK_L);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_GESTURE_RANGE_ATTACK_R);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_JUMP);
	REGISTER_SHARED_ACTIVITY(ACT_FR_DUALWIELD_GESTURE_RELOAD);
