...
Scheme
{
	...
	Colors
	{
		...
		"AchievementsLightGrey"		"101 101 168 255"
		"AchievementsDarkGrey"		"64 64 128 255"
		"AchievementsInactiveFG"	"32 32 100 255"
		"SMODBlue"			"64 64 128 255"
		"SMODBlueTrans"		"64 64 128 128"
		"SMODBlueDark"		"32 32 100 255"
		"SMODBlueDarkTrans"	"32 32 100 128"
		"SMODBlueBright"	"101 101 168 255"
		"SMODBlueBrightTrans"	"101 101 168 128"
		"SMODBlueBrightDark"	"101 101 148 255"
		"SMODBlueBrightDarkTrans"	"101 101 128 128"
		"SMODGray"			"82 82 82 255"
	...
	BaseSettings
	{
		...
		Frame.BgColor					"SMODBlue"
		Frame.OutOfFocusBgColor			"SMODBlueTrans"
		...
		Label.DisabledFgColor2			"SMODBlueDark"
		...
		Menu.BgColor					"SMODBlue"
		Menu.ArmedTextColor				"OffWhite"
		Menu.ArmedBgColor				"SMODBlueBright"
		Menu.TextInset					"6"
		...
		ScrollBarButton.BgColor				"SMODBlue"
		ScrollBarButton.ArmedFgColor		"White"
		ScrollBarButton.ArmedBgColor		"SMODBlueBright"
		...
		Slider.NobColor				"SMODBlue"
		Slider.TextColor			"180 180 180 255"
		Slider.TrackColor			"SMODBlueDark"
		...
		MainMenu.TextColor			"128 128 255 255"
